...
require(reshape2)
require(data.table)
data = read.csv("/Users/bonnie/Desktop/Case Comp Data Final.csv",header = T)
head(data)
dim(data)
plot(data$readmitted, xlab = "readmit", ylab="freq")
na.omit(data)
...
data2 = read.csv("/Users/bonnie/Desktop/DatathonMMA/data2.csv",header = T)
qplot(data2$OR, geom="histogram", binwidth=30) 
